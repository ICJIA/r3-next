(function() {
  ...
  var default_slugify = function(s, used_headers, namespace) {
    var slug = string(s)
      .slugify()
      .toString();
  ...
  var namedheaders = function(md, opts) {
    ...
    var namespace = opts && opts.namespace ? opts.namespace : "app";
    ...
    md.renderer.rules.heading_open = function(
      ...
      var slug = slugify(title, used_headers, namespace);
